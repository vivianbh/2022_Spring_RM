...
%   28/09/2011    SOH Madgwick    Initial release
    ...
    methods (Access = public)
        ...
        function obj = Update(obj, Gyroscope, Accelerometer, Magnetometer)
            ...
            g = -1;
            F = [-2*g*(q(2)*q(4)-q(1)*q(3)) - Accelerometer(1);
                 -2*g*(q(1)*q(2)-q(3)*q(4)) - Accelerometer(2);
                 -2*g*(0.5-q(2)^2-q(3)^2) - Accelerometer(3);
                 2*b(1)*(0.5-q(3)^2-q(4)^2) + 2*b(3)*(q(2)*q(4)-q(1)*q(3)) - Magnetometer(1);
                 2*b(1)*(q(2)*q(3)+q(1)*q(4)) + 2*b(3)*(q(1)*q(2)+q(3)*q(4)) - Magnetometer(2);
                 2*b(1)*(q(1)*q(3)+q(2)*q(4)) + 2*b(3)*(0.5-q(2)^2-q(3)^2) - Magnetometer(3)];
            J = [-2*g*(-q(3)), -2*g*q(4), -2*g*(-q(1)), -2*g*q(2);
                 -2*g*q(2), -2*g*q(1), -2*g*q(4), -2*g*q(3);
                 0, -2*g*(-2*q(2)), -2*g*(-2*q(3)), 0;
