...
for i=1:iter 
    ...
    x1_newton = x1_newton + t * (-0.1 * gradient1);
    x2_newton = x2_newton + t * (-1 * gradient2);
    
    %     ----------------Descent method---------------
    gradient1 = gradient_x1(x1_descent, x2_descent);
    gradient2 = gradient_x2(x1_descent, x2_descent);
    
    descent_step = 0.02;
    x1_descent = x1_descent + descent_step * (-gradient1);
    x2_descent = x2_descent + descent_step * (-gradient2);
